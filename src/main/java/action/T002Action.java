...
/**
 * Servlet controller for handling customer list display and search (T002
 * screen).
 *
 * <p>
 * Features:
 ...
 * <li>Handles customer listing with optional search filters and
 * pagination.</li>
 * <li>Validates birthday range input for search.</li>
 * <li>Preserves search criteria and shows relevant error messages if validation
 * fails.</li>
 * </ul>
 *
 * @author YourName
...
public class T002Action extends HttpServlet {
	...
	/**
	 * Handles the deletion of selected customers from the T002 screen.
	 * @param request
	 * @param response
	...
	protected void deleteCustomer(HttpServletRequest request, HttpServletResponse response)
	    ...
	    if ("delete".equals(action)) {
	        ...
	        if (ids == null || ids.length == 0) {
	            ...
	            // load lại danh sách bằng processRequest
	            processRequest(request, response);
	            return;
	        }
