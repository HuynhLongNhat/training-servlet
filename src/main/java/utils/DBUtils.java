 ...
 *
 * <p>This class loads DB configurations once and provides new JDBC connections
 * when needed. Ensures thread-safety and proper resource management.</p>
 *
 * @author YourName
 * @version 1.0
 * @since 2025-07-21
...
public class DBUtils {
     ...
     * Loads database configuration from dbConfig.properties.
     */
    private DBUtils() {
     ...
     *
     * @return DBUtils singleton instance
     */
