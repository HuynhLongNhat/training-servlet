 ...
 * intermediary between the presentation layer (controllers/actions) and the
 * data access layer ({@link T001Dao}).
 * </p>
 *
 * @author YourName
 * @version 1.0
...
public class T001Service {
	 ...
	 * credentials are valid, it returns the user details as a {@link T001Dto}
	 * object. Otherwise, it returns {@code null}.
	 * </p>
	 *
	 * @param t001Dto DTO containing {@code userId} and {@code password}
	 * @return {@link T001Dto} with authenticated user details, or {@code null} if
	 *         authentication fails
	 * @throws SQLException if a database access error occurs
	 */
	public T001Dto getUserLogin(T001Dto t001Dto) throws SQLException {
		T001Dto user = t001Dao.getUserLogin(t001Dto);
		if (user != null) {
			return null;
		}
		return user;
