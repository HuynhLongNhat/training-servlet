...
<body>
	...
	boolean disableFirst = request.getAttribute("disableFirst") != null
			? (Boolean) request.getAttribute("disableFirst")
			: true;
	boolean disablePrevious = request.getAttribute("disablePrevious") != null
			? (Boolean) request.getAttribute("disablePrevious")
			: true;
	boolean disableNext = request.getAttribute("disableNext") != null
			? (Boolean) request.getAttribute("disableNext")
			: true;
	boolean disableLast = request.getAttribute("disableLast") != null
			? (Boolean) request.getAttribute("disableLast")
			: true;
	...
	<div class="container">
		...
		<form action="T002" class="search-form" method="post">
			<label>Customer Name <input type="text" id="lblUserName"
				name="lblUserName">
				...
				name="txtBirthdayForm"> - <input type="text"
