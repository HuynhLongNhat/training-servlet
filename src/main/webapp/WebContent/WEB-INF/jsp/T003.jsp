	...
	<div class="container">
		...
		<div class="form-container">
			...
			<form action="T003" method="post" id="customerForm">
				<label class="error-message" id="lblErrorMessage"> <%=request.getAttribute("errorMessage") != null ? request.getAttribute("errorMessage") : ""%>
				</label>

				<div class="form-group">
					<label>Customer Id</label> <label id="lblCustomerID"> <%=customer != null ? customer.getCustomerID() : ""%>
					</label> <input type="hidden" id="txtCustomerId" name="txtCustomerId"
						value="<%=customer != null ? customer.getCustomerID() : ""%>" />

				</div>

				<div class="form-group">
					<label>Customer Name</label> <input type="text"
						id="txtCustomerName" name="txtCustomerName"
						value="<%=customer != null ? customer.getCustomerName() : ""%>">
				</div>

				<div class="form-group">
					<label>Sex</label> <select id="cboSex" name="cboSex">
						<option value=""></option>
						<option value="0"
							<%=(customer != null && "0".equals(customer.getSex())) ? "selected" : ""%>>Male</option>
						<option value="1"
							<%=(customer != null && "1".equals(customer.getSex())) ? "selected" : ""%>>Female</option>
					</select>
				</div>

				<div class="form-group">
					<label>Birthday</label> <input type="text" id="txtBirthday"
						name="txtBirthday"
